...
This is my third solution to the [QR code component challenge on Frontend Mentor](https://www.frontendmentor.io/challenges/qr-code-component-iux_sIO_H).
...
- A box-shadow arount the element itself  
- Turn the QR code into a live, clickable link

### Screenshot

![Screenshot of final submission](screenshot.png)
...
6. CSS: set up.
   1. "Pencil in" the major structure using GPS: "reset & variables," "containers," "elements," "classes & ids," "media queries"
   2. Write the CSS for the page reset in the ":root," `<html>`, `<body>`, and *. I generally put in the variable for colors, font, etc. at this time.
   3. Set the media queries, adding in a change of background color so I can visually identify what query I am viewing and to have an element in the query as a placeholder
